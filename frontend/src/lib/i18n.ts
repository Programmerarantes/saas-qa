...
export const translations = {
  'pt-BR': {
    nav: { home: 'Início', about: 'Sobre', articles: 'Artigos', cases: 'Cases', lab: 'Test Lab', admin: 'Admin' },
  ...
  en: {
    nav: { home: 'Home', about: 'About', articles: 'Articles', cases: 'Case studies', lab: 'Test Lab', admin: 'Admin' },
